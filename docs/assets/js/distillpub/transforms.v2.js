!(function (e, t) {
  ...
  function i(e) {
    ...
    if (t && "json" == t.getAttribute("type").split("/")[1]) {
  ...
  function h(e) {
    ...
    if (t && "SCRIPT" === t.tagName) {
      if ("text/bibtex" == t.type) return c(e.firstElementChild.textContent);
  ...
  function m(e, t, n, r) {
    ...
    let a = i.map((e) => {
      if (-1 != (e = e.trim()).indexOf(","))
        var n = e.split(",")[0].trim(),
          r = e.split(",")[1];
      else -1 != e.indexOf(" ") ? ((n = e.split(" ").slice(-1)[0].trim()), (r = e.split(" ").slice(0, -1).join(" "))) : (n = e.trim());
      var i = "";
      return (
        null != r &&
          (i =
    ...
    return i.length > 1 ? a.slice(0, i.length - 1).join(n) + ((r || n) + a[i.length - 1]) : a[0];
  }
  function g(e) {
  ...
  function T(e, t) {
    ...
    t.citations &&
      t.citations.forEach((e) => {
        t.bibliography && t.bibliography.has(e) && n("citation_reference", E(t.bibliography.get(e)));
      });
  }
  function N(e, t) {
    e.innerHTML += t;
  ...
  function O(e) {
    ...
    n && (L(n, t.querySelectorAll("h2, h3")), n.setAttribute("prerendered", "true"));
  }
  // Copyright 2018 The Distill Template Authors
  function q(e) {
   ...
   */ function D(e) {
    var t = "\xa0",
      n = /([\xab\xbf\xa1]) /g,
      r = / ([!?:;.,\u203d\xbb])/g;
    return (e = (e = (e = (e = e.replace(/--/g, "\u2014")).replace(/\s*\u2014\s*/g, "\u2009\u2014\u2009")).replace(/\.\.\./g, "\u2026")).replace(
      n,
      "$1" + t
    )).replace(r, t + "$1");
  }
  ...
  function P(e, t) {
    ...
    n && (H(n, new Map(t.citations.map((e) => [e, t.bibliography.get(e)])), e), n.setAttribute("distill-prerendered", "true"));
  }
  // Copyright 2018 The Distill Template Authors
  function j(e) {
    const t = e.head,
  ...
  function U(e, t) {
    ...
    if (n && !n.querySelector("distill-appendix")) {
  ...
  function Y(e) {
    if (!e.querySelector("distill-footer")) {
      ...
      (t.innerHTML = ke), e.querySelector("body").appendChild(t);
    }
  }
  // Copyright 2018 The Distill Template Authors
  function V(e, t, n = !0) {
            ...
            40: [
              function (e, t) {
                ...
                i(["array", "darray"], { numArgs: 1 }, function (e, t) {
                  ...
                  return r(e.parser, i, a(e.envName));
                }),
                  ...
                  i(["cases", "dcases"], {}, function (e) {
                    ...
                    return (t = r(e.parser, t, a(e.envName))), new o.default("leftright", { body: [t], left: "\\{", right: "." }, e.mode);
                  }),
  ...
  const oe = function (e, t, n) {
    ...
    ce = function (e, t) {
      for (let n = 0; n < e.childNodes.length; n++) {
        ...
        } else 1 === r.nodeType && -1 === t.ignoredTags.indexOf(r.nodeName.toLowerCase()) && ce(r, t);
      }
    },
    de = {
      delimiters: [
